...
import { NavbarComponent } from '../public/components/navbar/navbar.component'; // Tu componente navbar
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, NavbarComponent],  // Asegúrate de importar FormsModule y CommonModule
